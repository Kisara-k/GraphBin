...
def write_output(output_path, prefix, final_bins, contigs_file, contigs_map_rev, bins, contigs_map, bins_list, delimiter, node_count, remove_labels, non_isolated):
